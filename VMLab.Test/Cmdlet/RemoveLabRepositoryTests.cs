...
{
    [TestClass]
    public class RemoveLabRepositoryTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Remove-LabPackageRepository", typeof(RemoveLabPackageRepository), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Remove-LabPackageRepository");
        ...
        public void CallingCmdletWillPassParametersOnToPackageManager()
        {
            ...
            Manager.Verify(m => m.RemoveRepository("MyRepo"));
        }
