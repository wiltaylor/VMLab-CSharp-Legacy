...
{
    [TestClass]
    public class SyncLabPackagesTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Sync-LabPackages", typeof(SyncLabPackages), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Sync-LabPackages");
