...
namespace VMLab.Test.Cmdlet
{
    ...
    public class GetLabVMTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Get-LabVM", typeof(GetLabVM), string.Empty));
        ...
        public void CallingCmdletCallsDriver()
        {
            ...
            Assert.IsTrue(Pipe.Invoke().Any(v => v.ToString() == "MyVM"));
        }
