...
namespace VMLab.Test.Cmdlet
{
    ...
    public class ShowLabGUITests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Show-LabGUI", typeof(ShowLabGUI), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Show-LabGUI");
        ...
        [TestMethod]
        public void CallingShowLabGUIWillCallDriver()
        {
            Command.Parameters.Add(new CommandParameter("VMName", "MyVM"));

            Pipe.Invoke();

            Driver.Verify(d => d.ShowGUI("MyVM"));
        }
