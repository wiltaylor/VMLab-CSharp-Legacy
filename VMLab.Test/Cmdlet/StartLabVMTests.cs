...
namespace VMLab.Test.Cmdlet
{
    ...
    public class StartLabVMTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Start-LabVM", typeof(StartVMLab), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Start-LabVM");
        ...
        [TestMethod]
        public void CallingCmdletWillCallDriverToStartVM()
        {
