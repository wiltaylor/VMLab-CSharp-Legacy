...
{
    [TestClass]
    public class RemoveLabVMSnapshotTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Remove-LabVMSnapshot", typeof(RemoveLabVMSnapshot), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Remove-LabVMSnapshot");
        ...
        public void CallingCmdletWillCallDriver()
        {
            ...
            Command.Parameters.Add(new CommandParameter("Name", "MySnapshot"));

            Pipe.Invoke();

            Driver.Verify(d => d.RemoveSnapshot("MyVM", "MySnapshot"));
        }
