...
{
    [TestClass]
    public class RestoreLabVMSnapshotTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Restore-LabVMSnapshot", typeof(RestoreLabVMSnapshot), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Restore-LabVMSnapshot");
        ...
        public void CallingCmdletCallsDriver()
        {
            ...
            Driver.Verify(d => d.RevertToSnapshot("MyVM", "MySnapshot"));
        }
