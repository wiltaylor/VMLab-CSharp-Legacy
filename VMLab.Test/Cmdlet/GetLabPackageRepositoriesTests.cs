...
{
    [TestClass]
    public class GetLabPackageRepositoriesTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Get-LabPackageRepositories", typeof(GetLabPackageRepositories), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Get-LabPackageRepositories");
        ...
        public void CallingCmdletWillPassParametersOnToPackageManager()
        {
            ...
            Manager.Verify(m => m.GetRepository());
        }
