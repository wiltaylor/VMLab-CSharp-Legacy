...
{
    [TestClass]
    public class GetLabVMStateTests
    {
        ...
        public static void FixtureSetup(TestContext context)
        {
            ...
            Config.Cmdlets.Append(new CmdletConfigurationEntry("Get-LabVMState", typeof(GetLabVMState), string.Empty));
        ...
        public void Setup()
        {
            ...
            Command = new Command("Get-LabVMState");
        ...
        public void CallingCmdletCallsDriver()
        {
            ...
            Assert.IsTrue(Pipe.Invoke().Any(s => (VMState)s.BaseObject == VMState.Shutdown));
        }
